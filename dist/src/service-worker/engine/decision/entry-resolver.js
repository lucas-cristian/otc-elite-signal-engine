...
export class EntryResolver {
    ...
    resolveFromTick(decision, tick, payoutSnapshot) {
        ...
        if (tick.marketSourceIdentity.canonicalAssetId !== decision.canonicalAssetId)
            return null;
        if (decision.sourceFeedId === null || tick.marketSourceIdentity.feedId !== decision.sourceFeedId)
            return null;
        if (decision.marketEpisodeId === null || decision.arbitrationStatus !== 'PRIMARY')
            return null;
