> **Historical protocol v1 — superseded by `phase4_protocol_v4.md`. Experiment `P4-EURUSDOTC-V182-001` is retained but technically invalidated after the validation-authority freeze audit.**
